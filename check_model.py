"""
Interactive script to chat with the trained model.
Run:
    python nanoGPT/check_model.py
"""
import os
import torch
import tiktoken
...
def main():
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    out_dir = os.path.join(script_dir, 'out-fineweb')
    ...
    while True:
        prompt = input(f"[{temp=}, {top_k=}, {num_samples=}, {max_tokens=}] Prompt: ")
